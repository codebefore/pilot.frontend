...
const tr = {
  ...
  // Candidates page
  "candidates.tab.all":       "Tüm Adaylar",
  "candidates.tab.active":    "Aktif",
  "candidates.tab.completed": "Tamamlanan",
  ...
  "stats.activeGroups": "Aktif Grup",
  "stats.groupsSub": "Toplam: {count}",
...
const en: Record<keyof typeof tr, string> = {
  ...
  // Candidates page
  "candidates.tab.all":       "All Candidates",
  "candidates.tab.active":    "Active",
  "candidates.tab.completed": "Completed",
